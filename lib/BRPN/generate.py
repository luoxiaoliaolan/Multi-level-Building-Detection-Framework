##Generate Building Region Proposlas
from detection-network.config import cfg
...
def im_proposals(net, im):
    """Generate BRPN proposals on a single image."""
    blobs = {}
...
def imdb_proposals(net, imdb):
    """Generate BRPN proposals on all images in an imdb."""
